...
public class JBehaveRunnerAlfaHP extends JUnitStories {
    public JBehaveRunnerAlfaHP() {
        super();
        this.configuredEmbedder().candidateSteps().add(new AlfaTestStepsHP());
    }
...
//    @Override
    ...
    public InjectableStepsFactory stepsFactory() {
        return new InstanceStepsFactory(configuration, new AlfaTestStepsHP());
    }
